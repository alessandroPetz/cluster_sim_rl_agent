...
#define SIZE 2000               /* number of jobs - size of the output         */
...
// #define A2_BATCH          800
// #define B2_BATCH          0.014
// #define PA_BATCH          -0.003
// #define PB_BATCH          0.6986

#define A1_BATCH   0.65
#define B1_BATCH   1.20
#define A2_BATCH   800
#define B2_BATCH   0.012
#define PA_BATCH   -0.002
#define PB_BATCH   0.72
...
#define A1_ACTIVE         0.65 
#define B1_ACTIVE         1.2
#define A2_ACTIVE         800 
#define B2_ACTIVE         0.012 
#define PA_ACTIVE         -0.002 
#define PB_ACTIVE         0.72 
...
#define UMED              4.5
#define UHI               10         /* SYSTEM SIZE is 2^UHI == 128          */
#define UPROB             0.86
			...
			int start_hour , double weights[2][BUCKETS])
{
  ...
  memset(weights, 0, 2 * BUCKETS * sizeof(double));
